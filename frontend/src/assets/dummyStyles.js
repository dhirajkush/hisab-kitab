...
export const navbarStyles = {
  ...
  header: "sticky top-0 z-50 h-16 bg-white border-b border-gray-100 shadow-sm",
  container: "h-16 flex items-center justify-between px-4 md:px-8 max-w-none mx-auto",
  ...
  // Text styles
  logoText: "lg:text-2xl md:text-2xl text-xl text-gray-900 font-[550] lobster-regular",
